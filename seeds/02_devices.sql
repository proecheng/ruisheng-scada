-- v1.1 补全 NOT NULL 列：update_interval_decisec(100)/loss_count(0)/is_online(false)/is_enabled(true)/update_flag(0)
...
VALUES
  ('60270012', 'DEMO-SN-0001', 1, 9600, 'demo', '13800138000', 100, 0, FALSE, TRUE, 0)
